...
public class CartService {
    ...
    public void addToCart(int bookId) {
        ...
        int current = sessionCart.getOrDefault(bookId, 0);
        if (!book.isBookAvailable() || current >= book.getStock()) {
            throw new IllegalStateException("This book is out of stock or the requested quantity is unavailable.");
        }
        sessionCart.put(bookId, current + 1);
    }
